...
from tensorflowSeq2Seq.util.threading import Thread, SharedMemory
...
class TranslationDataset(Dataset):
    ...
    def load_data_to_memory(self):
        ...
        my_print('Loading data to memory!')
    ...
    def ptrs_to_tensor(self, ptrs):
        ...
        o = tf.constant(o, dtype=tf.int32)
